...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO competition (title,location,date,fee) VALUES('$title','$loc','$date','$fee')";
	$result=mysqli_query($con,$sql);
	if($result)
		{
			$msg="<p class='alert alert-success'>Competition Inserted Successfully</p>";
...
<head>
        ...
        <title>CompetitionAdd | Admin</title>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Add Competition Details</h4>
								</div>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="fee" required placeholder="Enter Fee">
													</div>
												</div>
												<div class="form-group row">
